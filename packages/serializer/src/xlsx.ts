...
function buildChartXml(chart: WorkbookSheet['charts'][number], existingSource?: string): string {
  ...
  const categoryAxisXml = chart.categoryAxisTitle || chart.categoryAxisPosition || chart.categoryAxisCrosses || chart.categoryAxisCrossesAt !== undefined || chart.categoryAxisMajorTickMark || chart.categoryAxisMinorTickMark || chart.categoryAxisTickLabelPosition || chart.categoryAxisDeleted !== undefined ? `<c:catAx>${chart.categoryAxisTitle ? `<c:title><c:tx><c:rich><a:t>${escapeXml(chart.categoryAxisTitle)}</a:t></c:rich></c:tx></c:title>` : ''}${chart.categoryAxisPosition ? `<c:axPos val="${escapeXml(chart.categoryAxisPosition)}"/>` : ''}${chart.categoryAxisCrosses ? `<c:crosses val="${escapeXml(chart.categoryAxisCrosses)}"/>` : ''}${chart.categoryAxisCrossesAt !== undefined ? `<c:crossesAt val="${chart.categoryAxisCrossesAt}"/>` : ''}${chart.categoryAxisMajorTickMark ? `<c:majorTickMark val="${escapeXml(chart.categoryAxisMajorTickMark)}"/>` : ''}${chart.categoryAxisMinorTickMark ? `<c:minorTickMark val="${escapeXml(chart.categoryAxisMinorTickMark)}"/>` : ''}${chart.categoryAxisTickLabelPosition ? `<c:tickLblPos val="${escapeXml(chart.categoryAxisTickLabelPosition)}"/>` : ''}${chart.categoryAxisDeleted !== undefined ? `<c:delete val="${chart.categoryAxisDeleted ? '1' : '0'}"/>` : ''}</c:catAx>` : '';
  const valueAxisXml = chart.valueAxisTitle || chart.valueAxisPosition || chart.valueAxisCrosses || chart.valueAxisCrossesAt !== undefined || chart.valueAxisCrossBetween || chart.valueAxisMinimum !== undefined || chart.valueAxisMaximum !== undefined || chart.valueAxisMajorUnit !== undefined || chart.valueAxisMinorUnit !== undefined || chart.valueAxisMajorTickMark || chart.valueAxisMinorTickMark || chart.valueAxisTickLabelPosition || chart.valueAxisDeleted !== undefined ? `<c:valAx>${chart.valueAxisTitle ? `<c:title><c:tx><c:rich><a:t>${escapeXml(chart.valueAxisTitle)}</a:t></c:rich></c:tx></c:title>` : ''}${chart.valueAxisMinimum !== undefined || chart.valueAxisMaximum !== undefined ? `<c:scaling>${chart.valueAxisMinimum !== undefined ? `<c:min val="${chart.valueAxisMinimum}"/>` : ''}${chart.valueAxisMaximum !== undefined ? `<c:max val="${chart.valueAxisMaximum}"/>` : ''}</c:scaling>` : ''}${chart.valueAxisPosition ? `<c:axPos val="${escapeXml(chart.valueAxisPosition)}"/>` : ''}${chart.valueAxisCrosses ? `<c:crosses val="${escapeXml(chart.valueAxisCrosses)}"/>` : ''}${chart.valueAxisCrossesAt !== undefined ? `<c:crossesAt val="${chart.valueAxisCrossesAt}"/>` : ''}${chart.valueAxisCrossBetween ? `<c:crossBetween val="${escapeXml(chart.valueAxisCrossBetween)}"/>` : ''}${chart.valueAxisMajorUnit !== undefined ? `<c:majorUnit val="${chart.valueAxisMajorUnit}"/>` : ''}${chart.valueAxisMinorUnit !== undefined ? `<c:minorUnit val="${chart.valueAxisMinorUnit}"/>` : ''}${chart.valueAxisMajorTickMark ? `<c:majorTickMark val="${escapeXml(chart.valueAxisMajorTickMark)}"/>` : ''}${chart.valueAxisMinorTickMark ? `<c:minorTickMark val="${escapeXml(chart.valueAxisMinorTickMark)}"/>` : ''}${chart.valueAxisTickLabelPosition ? `<c:tickLblPos val="${escapeXml(chart.valueAxisTickLabelPosition)}"/>` : ''}${chart.valueAxisDeleted !== undefined ? `<c:delete val="${chart.valueAxisDeleted ? '1' : '0'}"/>` : ''}</c:valAx>` : '';
