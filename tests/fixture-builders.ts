...
<c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><c:chart><c:title><c:tx><c:rich><a:t>Primary Chart</a:t></c:rich></c:tx></c:title><c:plotArea><c:barChart><c:ser><c:idx val="0"/><c:order val="0"/><c:tx><c:rich><a:t>North</a:t></c:rich></c:tx></c:ser><c:ser><c:idx val="1"/><c:order val="1"/><c:tx><c:rich><a:t>South</a:t></c:rich></c:tx></c:ser></c:barChart><c:catAx><c:title><c:tx><c:rich><a:t>Region</a:t></c:rich></c:tx></c:title><c:axPos val="b"/></c:catAx><c:valAx><c:title><c:tx><c:rich><a:t>Revenue</a:t></c:rich></c:tx></c:title><c:axPos val="l"/></c:valAx></c:plotArea><c:legend><c:legendPos val="r"/></c:legend></c:chart></c:chartSpace>`,
    'xl/charts/chart2.xml': `<?xml version="1.0" encoding="UTF-8"?>
<c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><c:chart><c:title><c:tx><c:rich><a:t>Alternate Chart</a:t></c:rich></c:tx></c:title><c:plotArea><c:lineChart><c:ser><c:idx val="0"/><c:order val="0"/><c:tx><c:rich><a:t>Forecast</a:t></c:rich></c:tx></c:ser></c:lineChart><c:catAx><c:title><c:tx><c:rich><a:t>Month</a:t></c:rich></c:tx></c:title><c:axPos val="l"/></c:catAx><c:valAx><c:title><c:tx><c:rich><a:t>Bookings</a:t></c:rich></c:tx></c:title><c:axPos val="r"/></c:valAx></c:plotArea><c:legend><c:legendPos val="b"/></c:legend></c:chart></c:chartSpace>`
  }));
}
