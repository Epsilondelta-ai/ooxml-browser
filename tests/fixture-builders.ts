...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/slide" Target="slides/slide1.xml"/></Relationships>`,
    'ppt/slides/slide1.xml': `<?xml version="1.0" encoding="UTF-8"?>
<p:sld xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><p:cSld><p:spTree><p:sp><p:nvSpPr><p:cNvPr id="2" name="Body"/></p:nvSpPr><p:txBody><a:bodyPr/><a:p><a:r><a:t>Animated slide</a:t></a:r></a:p></p:txBody></p:sp></p:spTree></p:cSld><p:transition spd="fast"><p:fade/></p:transition><p:timing><p:tnLst><p:par><p:cTn id="10" presetClass="entr" presetID="1" dur="500" repeatCount="1" restart="always" fill="hold"/><p:stCondLst><p:cond evt="onBegin" delay="0"/></p:stCondLst><p:tgtEl><p:spTgt spid="2"/></p:tgtEl></p:par><p:seq><p:cTn id="20" presetClass="exit" presetID="2" dur="750" repeatCount="indefinite" restart="whenNotActive" fill="freeze"/><p:stCondLst><p:cond evt="onClick" delay="250"/></p:stCondLst><p:tgtEl><p:spTgt spid="2"/></p:tgtEl></p:seq></p:tnLst></p:timing></p:sld>`
  }));
}
