...
<c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><c:chart><c:title><c:tx><c:rich><a:t>Primary Chart</a:t></c:rich></c:tx></c:title><c:plotArea><c:barChart><c:grouping val="clustered"/><c:varyColors val="1"/><c:ser><c:idx val="0"/><c:order val="0"/><c:tx><c:rich><a:t>North</a:t></c:rich></c:tx><c:invertIfNegative val="0"/><c:marker><c:symbol val="circle"/><c:size val="8"/></c:marker></c:ser><c:ser><c:idx val="1"/><c:order val="1"/><c:tx><c:rich><a:t>South</a:t></c:rich></c:tx><c:invertIfNegative val="1"/><c:marker><c:symbol val="square"/><c:size val="10"/></c:marker></c:ser><c:dLbls><c:dLblPos val="outEnd"/><c:separator> · </c:separator><c:showVal val="1"/><c:showCatName val="0"/><c:showSerName val="1"/><c:showLegendKey val="0"/><c:showLeaderLines val="1"/><c:showPercent val="1"/><c:showBubbleSize val="0"/></c:dLbls><c:gapWidth val="180"/><c:overlap val="0"/></c:barChart><c:catAx><c:title><c:tx><c:rich><a:t>Region</a:t></c:rich></c:tx></c:title><c:axPos val="b"/><c:crosses val="autoZero"/><c:crossesAt val="1"/></c:catAx><c:valAx><c:title><c:tx><c:rich><a:t>Revenue</a:t></c:rich></c:tx></c:title><c:scaling><c:min val="0"/><c:max val="250"/></c:scaling><c:axPos val="l"/><c:crosses val="max"/><c:crossesAt val="0"/></c:valAx></c:plotArea><c:legend><c:legendPos val="r"/></c:legend><c:plotVisOnly val="1"/><c:dispBlanksAs val="gap"/></c:chart></c:chartSpace>`,
