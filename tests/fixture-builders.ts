...
<c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><c:chart><c:title><c:tx><c:rich><a:t>Primary Chart</a:t></c:rich></c:tx></c:title><c:plotArea><c:barChart><c:grouping val="clustered"/><c:varyColors val="1"/><c:ser><c:idx val="0"/><c:order val="0"/><c:tx><c:rich><a:t>North</a:t></c:rich></c:tx><c:invertIfNegative val="0"/><c:marker><c:symbol val="circle"/><c:size val="8"/></c:marker></c:ser><c:ser><c:idx val="1"/><c:order val="1"/><c:tx><c:rich><a:t>South</a:t></c:rich></c:tx><c:invertIfNegative val="1"/><c:marker><c:symbol val="square"/><c:size val="10"/></c:marker></c:ser><c:dLbls><c:dLblPos val="outEnd"/><c:showVal val="1"/><c:showCatName val="0"/><c:showSerName val="1"/><c:showLegendKey val="0"/><c:showLeaderLines val="1"/></c:dLbls><c:gapWidth val="180"/><c:overlap val="0"/></c:barChart><c:catAx><c:title><c:tx><c:rich><a:t>Region</a:t></c:rich></c:tx></c:title><c:axPos val="b"/></c:catAx><c:valAx><c:title><c:tx><c:rich><a:t>Revenue</a:t></c:rich></c:tx></c:title><c:axPos val="l"/></c:valAx></c:plotArea><c:legend><c:legendPos val="r"/></c:legend><c:plotVisOnly val="1"/><c:dispBlanksAs val="gap"/></c:chart></c:chartSpace>`,
    'xl/charts/chart2.xml': `<?xml version="1.0" encoding="UTF-8"?>
<c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><c:chart><c:title><c:tx><c:rich><a:t>Alternate Chart</a:t></c:rich></c:tx></c:title><c:plotArea><c:lineChart><c:grouping val="standard"/><c:smooth val="1"/><c:varyColors val="0"/><c:ser><c:idx val="0"/><c:order val="0"/><c:tx><c:rich><a:t>Forecast</a:t></c:rich></c:tx><c:invertIfNegative val="0"/><c:marker><c:symbol val="diamond"/><c:size val="6"/></c:marker></c:ser><c:dLbls><c:dLblPos val="bestFit"/><c:showVal val="0"/><c:showCatName val="1"/><c:showSerName val="0"/><c:showLegendKey val="1"/><c:showLeaderLines val="0"/></c:dLbls><c:gapWidth val="90"/><c:overlap val="-20"/></c:lineChart><c:catAx><c:title><c:tx><c:rich><a:t>Month</a:t></c:rich></c:tx></c:title><c:axPos val="l"/></c:catAx><c:valAx><c:title><c:tx><c:rich><a:t>Bookings</a:t></c:rich></c:tx></c:title><c:axPos val="r"/></c:valAx></c:plotArea><c:legend><c:legendPos val="b"/></c:legend><c:plotVisOnly val="0"/><c:dispBlanksAs val="span"/></c:chart></c:chartSpace>`
  }));
}
