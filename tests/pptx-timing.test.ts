...
describe('pptx timing and transitions', () => {
  it('parses slide transition and timing node metadata', async () => {
    ...
    expect(slide?.timing?.nodes).toEqual([
      ...
      { nodeType: 'animClr', presetClass: 'emph', presetId: '3', id: '30', duration: '600', repeatDuration: '900', repeatCount: '1', restart: 'always', fill: 'hold', autoReverse: false, acceleration: '2000', deceleration: '3000', triggerEvent: 'withPrevious', triggerDelay: '50', triggerShapeId: '3', endTriggerEvent: 'onEnd', endTriggerDelay: '75', endTriggerShapeId: '4', targetShapeId: '2' },
