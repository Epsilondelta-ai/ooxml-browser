...
describe('xlsx chart relationships', () => {
  ...
  it('renders line-family decoration metadata', async () => {
    ...
    expect(html).toContain('Alternate Chart <lineChart> [Alternate Chart] smooth:true dropLines:true hiLowLines:false serLines:true upDownBars:false plotVisibleOnly:false blanks:span roundedCorners:false grouping:standard overlap:-20 varyColors:false gapWidth:90 legend:b legendOverlay:true cat:Month catPos:l val:Bookings valPos:r dLblPos:bestFit dLblSep:/ showVal:false showCat:true showSeries:false showLegendKey:true showLeaderLines:false showPercent:false showBubble:true {Forecast invert:false marker:diamond size:6} (/xl/charts/chart2.xml)');
