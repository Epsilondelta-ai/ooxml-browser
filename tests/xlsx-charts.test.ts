...
describe('xlsx chart relationships', () => {
  it('parses worksheet chart relationship metadata', async () => {
    ...
    expect(chart).toEqual({
      ...
      valueAxisPosition: 'l',
      dataLabels: { position: 'outEnd', showValue: true, showCategoryName: false, showSeriesName: true, showLegendKey: false },
      series: [
