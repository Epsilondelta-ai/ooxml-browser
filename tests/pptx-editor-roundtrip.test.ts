...
describe('pptx editor round-trips', () => {
  ...
  it('persists edited slide timing metadata', async () => {
    ...
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('<p:animMotion origin="layout" path="M 0 0 L 0.5 0.5">');
