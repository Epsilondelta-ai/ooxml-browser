...
describe('pptx editor round-trips', () => {
  ...
  it('persists edited slide timing metadata', async () => {
    ...
    setPresentationTimingNodes(editor, 0, [
      ...
      { nodeType: 'animClr', presetClass: 'emph', presetId: '33', id: '303', duration: '450', repeatDuration: '900', repeatCount: '1', restart: 'always', fill: 'remove', autoReverse: true, acceleration: '5000', deceleration: '1000', colorSpace: 'rgb', colorDirection: 'ccw', triggerEvent: 'withPrevious', triggerDelay: '0', triggerShapeId: '3', endTriggerEvent: 'onClick', endTriggerDelay: '0', endTriggerShapeId: '4', targetShapeId: '2' },
      { nodeType: 'animMotion', presetClass: 'path', presetId: '44', id: '404', duration: '650', repeatDuration: '1300', repeatCount: '2', restart: 'never', fill: 'hold', autoReverse: false, acceleration: '700', deceleration: '900', motionOrigin: 'layout', motionPath: 'M 0 0 L 0.5 0.5', motionPathEditMode: 'relative', triggerEvent: 'onClick', triggerDelay: '30', triggerShapeId: '3', endTriggerEvent: 'afterEffect', endTriggerDelay: '60', endTriggerShapeId: '4', targetShapeId: '2' },
      { nodeType: 'cmd', presetClass: 'verb', presetId: '55', id: '505', duration: '200', repeatDuration: '400', repeatCount: '1', restart: 'always', fill: 'hold', autoReverse: false, acceleration: '100', deceleration: '200', commandName: 'togglePause', commandType: 'call', triggerEvent: 'withPrevious', triggerDelay: '10', triggerShapeId: '3', endTriggerEvent: 'onEnd', endTriggerDelay: '20', endTriggerShapeId: '4', targetShapeId: '2' }
    ]);
    ...
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('<p:animClr clrSpc="rgb" dir="ccw">');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('<p:animMotion origin="layout" path="M 0 0 L 0.5 0.5" pathEditMode="relative">');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('<p:cmd cmd="togglePause" type="call">');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('clrSpc="rgb"');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('dir="ccw"');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('origin="layout"');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('path="M 0 0 L 0.5 0.5"');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('pathEditMode="relative"');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('cmd="togglePause"');
    expect(reopenedGraph.parts['/ppt/slides/slide1.xml']?.text).toContain('type="call"');
