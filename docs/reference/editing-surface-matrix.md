...
| Chart axis positions/crossings | `setWorksheetChartCategoryAxisPosition`, `setWorksheetChartValueAxisPosition`, `setWorksheetChartCategoryAxisCrosses`, `setWorksheetChartValueAxisCrosses`, `setWorksheetChartCategoryAxisCrossesAt`, `setWorksheetChartValueAxisCrossesAt`, `setWorksheetChartCategoryAxisMajorTickMark`, `setWorksheetChartCategoryAxisMinorTickMark`, `setWorksheetChartValueAxisMinimum`, `setWorksheetChartValueAxisMaximum`, `setWorksheetChartValueAxisMajorUnit`, `setWorksheetChartValueAxisMinorUnit`, `setWorksheetChartValueAxisMajorTickMark`, `setWorksheetChartValueAxisMinorTickMark` | Persisted | Preserves axis-position, crossing, crossing-point, and category/value-axis scaling/step/tick-mark metadata inside the chart part while keeping chart relationships stable. |
