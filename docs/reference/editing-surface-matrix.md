...
| Chart axis positions/crossings | `setWorksheetChartCategoryAxisPosition`, `setWorksheetChartValueAxisPosition`, `setWorksheetChartCategoryAxisCrosses`, `setWorksheetChartValueAxisCrosses` | Persisted | Preserves axis-position and crossing metadata inside the chart part while keeping chart relationships stable. |
