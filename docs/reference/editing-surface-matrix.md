...
| Chart title overlay | `setWorksheetChartTitleOverlay` | Persisted | Preserves chart-title overlay policy inside chart parts without disturbing worksheet or drawing relationships. |
...
| Bar chart direction | `setWorksheetChartBarDirection` | Persisted | Preserves bar-chart `barDir` metadata inside chart parts without disturbing worksheet or drawing relationships. |
| Chart smooth line mode | `setWorksheetChartSmooth` | Persisted | Preserves line-chart smoothing metadata inside chart parts. |
| Chart legend position / overlay | `setWorksheetChartLegendPosition`, `setWorksheetChartLegendOverlay` | Persisted | Preserves legend placement and overlay policy inside the chart part while keeping the worksheet/drawing graph stable. |
...
| Chart axis positions/crossings | `setWorksheetChartCategoryAxisPosition`, `setWorksheetChartValueAxisPosition`, `setWorksheetChartCategoryAxisCrosses`, `setWorksheetChartValueAxisCrosses`, `setWorksheetChartCategoryAxisCrossesAt`, `setWorksheetChartValueAxisCrossesAt`, `setWorksheetChartValueAxisCrossBetween`, `setWorksheetChartCategoryAxisMajorGridlines`, `setWorksheetChartCategoryAxisMinorGridlines`, `setWorksheetChartCategoryAxisMajorTickMark`, `setWorksheetChartCategoryAxisTickMarkSkip`, `setWorksheetChartCategoryAxisMinorTickMark`, `setWorksheetChartCategoryAxisTickLabelPosition`, `setWorksheetChartCategoryAxisTickLabelSkip`, `setWorksheetChartCategoryAxisLabelAlignment`, `setWorksheetChartCategoryAxisNoMultiLevelLabels`, `setWorksheetChartCategoryAxisLabelOffset`, `setWorksheetChartCategoryAxisDeleted`, `setWorksheetChartValueAxisMinimum`, `setWorksheetChartValueAxisMaximum`, `setWorksheetChartValueAxisMajorUnit`, `setWorksheetChartValueAxisMinorUnit`, `setWorksheetChartValueAxisMajorGridlines`, `setWorksheetChartValueAxisMinorGridlines`, `setWorksheetChartValueAxisMajorTickMark`, `setWorksheetChartValueAxisMinorTickMark`, `setWorksheetChartValueAxisTickLabelPosition`, `setWorksheetChartValueAxisDeleted`, `setWorksheetChartValueAxisDisplayUnits` | Persisted | Preserves axis-position, crossing, crossing-point/cross-between, and category/value-axis scaling/step/gridline/tick/tick-label/tick-skip/tick-mark-skip/label-alignment/multilevel-label/label-offset/visibility/display-unit metadata inside the chart part while keeping chart relationships stable. |
...
| Chart rounded corners | `setWorksheetChartRoundedCorners` | Persisted | Preserves chart-level rounded-corner policy inside chart parts. |
