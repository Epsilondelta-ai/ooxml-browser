...
| Chart data labels | `setWorksheetChartDataLabels`, `setWorksheetChartDataLabelVisibility` | Persisted | Preserves chart-part data-label metadata such as label position and visibility flags. |
