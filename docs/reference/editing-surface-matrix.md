...
| Chart axis positions/crossings | `setWorksheetChartCategoryAxisPosition`, `setWorksheetChartValueAxisPosition`, `setWorksheetChartCategoryAxisCrosses`, `setWorksheetChartValueAxisCrosses`, `setWorksheetChartCategoryAxisCrossesAt`, `setWorksheetChartValueAxisCrossesAt`, `setWorksheetChartValueAxisCrossBetween`, `setWorksheetChartCategoryAxisMajorTickMark`, `setWorksheetChartCategoryAxisMinorTickMark`, `setWorksheetChartCategoryAxisTickLabelPosition`, `setWorksheetChartCategoryAxisDeleted`, `setWorksheetChartValueAxisMinimum`, `setWorksheetChartValueAxisMaximum`, `setWorksheetChartValueAxisMajorUnit`, `setWorksheetChartValueAxisMinorUnit`, `setWorksheetChartValueAxisMajorTickMark`, `setWorksheetChartValueAxisMinorTickMark`, `setWorksheetChartValueAxisTickLabelPosition`, `setWorksheetChartValueAxisDeleted`, `setWorksheetChartValueAxisDisplayUnits` | Persisted | Preserves axis-position, crossing, crossing-point/cross-between, and category/value-axis scaling/step/tick/tick-label/visibility/display-unit metadata inside the chart part while keeping chart relationships stable. |
