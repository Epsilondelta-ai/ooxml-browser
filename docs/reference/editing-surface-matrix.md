...
| Chart axis positions/crossings | `setWorksheetChartCategoryAxisPosition`, `setWorksheetChartValueAxisPosition`, `setWorksheetChartCategoryAxisCrosses`, `setWorksheetChartValueAxisCrosses`, `setWorksheetChartCategoryAxisCrossesAt`, `setWorksheetChartValueAxisCrossesAt`, `setWorksheetChartCategoryAxisMajorTickMark`, `setWorksheetChartCategoryAxisMinorTickMark`, `setWorksheetChartCategoryAxisTickLabelPosition`, `setWorksheetChartValueAxisMinimum`, `setWorksheetChartValueAxisMaximum`, `setWorksheetChartValueAxisMajorUnit`, `setWorksheetChartValueAxisMinorUnit`, `setWorksheetChartValueAxisMajorTickMark`, `setWorksheetChartValueAxisMinorTickMark`, `setWorksheetChartValueAxisTickLabelPosition` | Persisted | Preserves axis-position, crossing, crossing-point, and category/value-axis scaling/step/tick/tick-label metadata inside the chart part while keeping chart relationships stable. |
