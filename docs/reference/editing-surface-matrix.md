...
| Timing nodes | `setPresentationTimingNodes` | Persisted | Parser/editor/serializer preserve core `p:cTn` metadata including IDs, durations, repeat counts, and preset markers. |
...
- PPTX richer animation graph editing beyond core `p:cTn` metadata
